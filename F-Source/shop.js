document.addEventListener('DOMContentLoaded', () => {
    ...
    .catch(error => {
        ...
        shopContainer.innerHTML = `<div style="margin-left : 46%; margin-right : 40%;"> <img style=" height : 50px ; margin-left : auto; margin-right : auto; margin : auto;" src="./imgs/icons/cry.png"></div> <p> Could not load the shop (Maybe servers are under manteinance?). ${error.message}</p>`;
    });
